...
<template>
  ...
  <div class="addressWrapper">
    <div class="text item" :class="{active: activeAddress.id === item.id}" v-for="item in checkInfo.userAddresses" @click="isclick(item)"  :key="item.id">
      <ul>
  ...
  <template #footer>
    <span class="dialog-footer">
      ...
      <el-button type="primary" @click="switchAddres">确定</el-button>
    </span>
  </template>
</el-dialog>
  <!-- 添加地址 -->
